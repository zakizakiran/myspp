...
class _AdminSettingsState extends ConsumerState<AdminSettings> {
  ...
  deleteAktivitasDialog(BuildContext context) async {
    showDialog(
        context: context,
        builder: (ctx) {
          return AlertDialog(
            ...
            actionsAlignment: MainAxisAlignment.spaceEvenly,
            title: const Text(
              'Apakah anda yakin akan mengahapus semua aktivitas?',
              style: TextStyle(fontSize: 16.0),
            ),
            actions: [
              ElevatedButton(
                onPressed: () async {
                  ...
                  try {
                    ...
                    Snackbars().successSnackbars(
                        context, 'Berhasil', 'Berhasil Menghapus Aktivitas');
